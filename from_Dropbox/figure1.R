...
q = 2;  t1=0.5; t2=0.6; t3 = 0.6; t4=0.7;
...
par(mfrow=c(2,2))
# dA, t=0.1
plot(x, sapply(x, function(x) d_t(x,t=t1,type=1)),col="black",xlim=c(-1.10,1.10),ylim=c(-2.5,0.5),ylab=expression('d'["A"]),type="l",main="(a)");abline(h=0,col="red",lty="dashed");
# dA, t=0.6
plot(x, sapply(x, function(x) d_t(x,t=t2,type=1)),col="black",xlim=c(-1.10,1.10),ylim=c(-2.5,0.5),ylab=expression('d'["A"]),type="l",main="(b)");abline(h=0,col="red",lty="dashed");
title("(b)")
# dD, t = 0.2
plot(x, sapply(x, function(x) d_t(x,t=t3,type=2)),col="black",xlim=c(-1.10,1.10),ylim=c(-2.5,0.5),ylab=expression('d'["D"]),type="l",main="(c)"); abline(h=0,col="red",lty="dashed");
# dD, t = 0.6
plot(x, sapply(x, function(x) d_t(x,t=t4,type=2)),col="black",xlim=c(-1.10,1.10),ylim=c(-2.5,0.5),ylab=expression('d'["D"]),type="l",main="(d)"); abline(h=0,col="red",lty="dashed");
